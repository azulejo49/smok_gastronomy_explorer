...
const CookingStage = ({ selectedIngredients, onBack, onClearIngredients }) => {
  ...
  const BlackTruffle = {
    ...
    image: "/images/blacktruff.jpg",
  };
  const WhiteTruffle = {
    id: "truffle-002",
    name: "White Truffle",
    description: "Rare white truffle with earthy aroma",
    image: "/images/whitetruff.jpg",
  };

// Add ingredient to localIngredients
const addIngredient = (ingredient) => {
  ...
  // Sync localIngredients with selectedIngredients
  useEffect(() => {
  ...
  return (
    <div className="relative flex flex-col items-center min-h-screen py-4 cooking-background">
      <div className="absolute inset-0 pointer-events-none z-10">
  <svg
    className="w-full h-full"
    preserveAspectRatio="xMidYMid slice"
  >
    {/* Example decoration: subtle circles or lines */}
    {/* You can add more decorative elements as needed */}
    <circle cx="50" cy="50" r="20" fill="#fff" opacity="0.1" />
    <rect x="150" y="100" width="100" height="20" fill="#fff" opacity="0.05" rx="4" ry="4" />
    {/* Add more SVG shapes for ambiance */}
  </svg>
</div>
      ...
      <div className="w-full max-w-4xl flex flex-col items-center">
        ...
        <div className="relative mb-6 flex justify-center w-full">
          ...
          <div className="absolute -left-40 top-0 w-64 h-64">
            {/* Your SVG for Chef here */}
            <svg viewBox="0 0 200 200" className="w-full h-full">
              {/* ... your SVG code for Chef ... */}
              <path
                d="M65,40 C60,15 140,15 135,40 C150,45 150,60 135,65 H65 C50,60 50,45 65,40 Z"
                fill="#FFFFFF"
                stroke="#000"
                strokeWidth="2"
              />
              ...
              />
              <path
                d="M100,75 C80,75 75,100 100,115 C125,100 120,75 100,75 Z"
                fill="#FDD7AA"
                stroke="#000"
                strokeWidth="1"
              />
  ...
  <div
    className={`bg-yellow-100 p-5 rounded-lg border-2 border-yellow-300 mb-6 w-full max-w-2xl ${
  ...
  >
    ...
    <p className="mt-3 text-base font-medium text-green-600 text-center">
      ...
      <div className="flex justify-between w-full mt-4 space-x-4">
        <button
          onClick={onBack}
          className="bg-blue-500 hover:bg-purple-600 text-white px-4 py-2 rounded-lg font-bold flex-1"
        >
          ...
          <div className="bg-white rounded-lg shadow-xl p-6 max-w-md w-full relative">
            ...
            {showFireworks && (
              <div className="absolute inset-0 pointer-events-none">
                <div
                  className="absolute top-0 left-1/4 animate-ping"
